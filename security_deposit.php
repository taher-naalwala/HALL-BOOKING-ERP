        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4 ">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Security Deposit</h6>
                </div>
                <div class="card-body">
                    <form method="GET">
                        <div class="row">
                ...
                if (isset($_GET['submit'])) {
                    ...
                    if ($type == "booking_id") {
                        $sql2 = "SELECT its,name,mobile,jk_id,date,timings_id,laagat,thaals,status from booking_info WHERE status=3 AND id=$input AND laagat!='' AND thaals!='' AND manager_approval=0 AND sc_deposit!=''";
                        ...
                        ?>
                            ...
                            <form method="POST">
                                ...
                                <button name="cleared" class="btn btn-success" value='<?php echo $id ?>'>Approve</button>
                                <button name="fail" class="btn btn-danger" value='<?php echo $id ?>'>Disapproved</button>
                            ...
                            if (isset($_POST['cleared'])) {
                                $id = $_POST['cleared'];
                                $input = $_GET['input'];
                                $sql = "UPDATE booking_info SET manager_approval=1 WHERE id=$id";
                                if (mysqli_query($conn, $sql)) {
                                    ...
                                    $msg = "Security Deposit Refund Process Approved By Manager..%0D%0A" . "Booking Details- %0D%0A" . "Booking ID: " . $input . "%0D%0AJamaat Khana: " . $jk_name . "%0D%0ABooking Date: " . $date . "%0D%0ATimings: " . $label_name . " (" . $final_start_time . " - " . $final_end_time . ")" . "%0D%0AAmount: " . $amount . "%0D%0ACapacity: " . $capacity . " Thaals%0D%0ALaagat: " . $laagat . "%0D%0AThaals: " . $thaals . "%0D%0A%0D%0AUser Details:%0D%0AITS: " . $its . "%0D%0AName: " . $name . "%0D%0AMobile Number: " . $mobile . "%0D%0A%0D%0A";
                            ...
                            if (isset($_POST['fail'])) {
                                ...
                                $sql = "UPDATE booking_info SET manager_approval=2 WHERE id=$id";
                                if (mysqli_query($conn, $sql)) {
                                    $s2 = "SELECT its,name,mobile,jk_id,date,timings_id  from booking_info WHERE id=$id";
                                    $run2 = $conn->query($s2);
                                    $row2 = $run2->fetch_assoc();
                                    ...
                                    $msg = "Security Deposit Refund Process Not Approved By Manager..%0D%0A" . "Booking Details- %0D%0A" . "Booking ID: " . $input . "%0D%0AJamaat Khana: " . $jk_name . "%0D%0ABooking Date: " . $date . "%0D%0ATimings: " . $label_name . " (" . $final_start_time . " - " . $final_end_time . ")" . "%0D%0AAmount: " . $amount . "%0D%0ACapacity: " . $capacity . " Thaals%0D%0ALaagat: " . $laagat . "%0D%0AThaals: " . $thaals . "%0D%0A%0D%0AUser Details:%0D%0AITS: " . $its . "%0D%0AName: " . $name . "%0D%0AMobile Number: " . $mobile . "%0D%0A%0D%0A";
                                    $final_msg = str_replace(" ", "%20", $msg);
                                    $url = 'http://prime.sms-excel.com/submitsms.jsp?user=aesindor&key=00a7b283abXX&mobile=+91' . $mobile . '&message=' . $final_msg . '&senderid=INFOSM&accusage=1';
                        ...
                        $sql2 = "SELECT its,name,mobile,jk_id,date,timings_id,laagat,thaals,status  from booking_info WHERE status=3 AND its=$input AND laagat!='' AND thaals!='' AND manager_approval=0  AND sc_deposit!=''";
                            ...
                            <?php if ($run2->num_rows > 0) {
                                while ($row = $run2->fetch_assoc()) { ?>
                                    ...
                                    <form method="POST">
                                        ...
                                        <button name="cleared" class="btn btn-success" value='<?php echo $id ?>'>Clear</button>
                                        <button name="fail" class="btn btn-danger" value='<?php echo $id ?>'>Fail</button>
