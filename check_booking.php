    ...
    <div class="card mt-2" id="forms">
        ...
        <div class="card-body" style="background-color: #F7F5E6;">
            ...
            if (isset($_POST['submit'])) {
                ...
                if ($otp == $number) {
                    $sql = "INSERT INTO booking_info VALUES('','$its','$name','$mobile','$date',$jk_id,$timings_id,1)";
                    if (mysqli_query($conn, $sql)) {
                        ...
                        $booking_id = $row5['id'];
                        $msg = "Booking Confirmed..%0D%0A" . "Booking Details- %0D%0A" . "Booking ID: " . $booking_id . "%0D%0AJamaat Khana: " . $jk_name . "%0D%0ABooking Date: " . $date . "%0D%0ATimings: " . $label_name . " (" . $final_start_time . " - " . $final_end_time . ")" . "%0D%0AAmount: " . $amount . "%0D%0ACapacity: " . $capacity . "%0D%0A%0D%0AUser Details:%0D%0AITS: " . $its . "%0D%0AName: " . $name . "%0D%0AMobile Number: " . $mobile . "%0D%0A%0D%0APay the Amount within 48 hours or your booking will be cancelled";
            ...
            ?>
                        ...
                        <div class="alert alert-warning text-center" role="alert">
                            <b> Pay the Amount within 48 hours or your booking will be cancelled </b>
                        </div>
                        <div class="card">
                            <div class="card-body">
