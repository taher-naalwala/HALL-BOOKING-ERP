        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4 ">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Laagat</h6>
                </div>
                <div class="card-body">
                    <form method="GET">
                        <div class="row">
                ...
                if (isset($_GET['submit'])) {
                    ...
                    if ($type == "booking_id") {
                        $sql2 = "SELECT its,name,mobile,jk_id,date,timings_id,status,jk_rent from booking_info WHERE status=3 AND id=$input AND laagat='' AND thaals=''";
                        ...
                        ?>
                            ...
                            <form method="POST">
                                ...
                                if (isset($_POST['cleared'])) {
                                    ...
                                    $laagat = $_POST['laagat'];
                                    $thaals = $_POST['thaals'];
                                    if (empty($laagat) || empty($thaals)) {
                                    } else {
                                        $sql = "UPDATE booking_info SET laagat='$laagat',thaals='$thaals',sc_deposit='$scd' WHERE id=$input";
                                        if (mysqli_query($conn, $sql)) {
                                            ...
                                            $s2 = "SELECT its,name,mobile,date,jk_id,timings_id from booking_info WHERE id=$input";
                                            $run2 = $conn->query($s2);
                        ...
                        $sql2 = "SELECT id,name,mobile,jk_id,date,timings_id from booking_info WHERE status=3 AND its=$input AND laagat='' AND thaals=''";
