...
<body>
    ...
    <div class="card mt-2" id="forms">
        ...
        <div class="card-body" style="background-color: #F7F5E6;">
            ...
            <form method="POST" action="transfer_check_booking_admin.php">
                <input type="hidden" name="date" value="<?php echo $date ?>" />
                <input type="hidden" name="timings_id" value="<?php echo $timings_id ?>" />
                ...
                <button name="submit" value="submit" class="btn btn-primary btn-block">TRANSFER NOW</button>
            </form>
